...
QT_MOC_LITERAL(3, 27, 19), // "handleBinaryMessage"
QT_MOC_LITERAL(4, 47, 3), // "msg"
QT_MOC_LITERAL(5, 51, 17) // "onSocketConnected"

    },
    "websocket\0socketConnected\0\0"
...
void websocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&websocket::socketConnected)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void websocket::socketConnected()
{
